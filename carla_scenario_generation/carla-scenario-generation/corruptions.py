...
def test_albu(img, aug_type):
    ...
    if aug_type == 'sun_flare':
        ...
        transform = AUG.RandomFog(fog_coef_lower=0.3, fog_coef_upper=1, alpha_coef=0.3, always_apply=True)
        ...
        transform = AUG.RandomRain(slant_lower=-10, slant_upper=10, 
                          ...
                          rain_type=rain_types[3], always_apply=True)
