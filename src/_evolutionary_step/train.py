...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    # Trainloader
    train_path = os.path.join(train_path, opt.threat_type) #LAAS
    ...
    # Process 0
    val_path = os.path.join(val_path, opt.threat_type) #LAAS
    if RANK in [-1, 0]:
...
def parse_opt(known=False):
    ...
    # LAAS arguments
    parser.add_argument('--threat_type', type=str, default='smoke', help='smoke, sun_flare')
